...
if ($exports -notmatch 'VioGpuDxvkCreateDdiTestDevice' -or $exports -match 'D3D11CreateDevice') { throw 'Unexpected UMD development exports' }
...
Runtime-to-DDI activation, complete shader/draw table, sharing and Present remain pending.
